...
{
    public class RecordTechnicalSupportDataEvent : IDomainEvent
    {
        ...
        public RecordTechnicalSupportDataEvent(
            UserId userId,
            UserName userName,
            UserEmail email,
            UserPhone phone,
        ...
        public string EventName => nameof(RecordTechnicalSupportDataEvent);
